...
MESSAGE_NO_MUTE_RANKING_DATA = "まだ寝落ちミュートされたデータがありません。"
...
EMBED_FIELD_MUTE_RANKING = "月間: 自動ミュート回数ランキング"
EMBED_FIELD_TOTAL_CALL_TIME = "総通話時間"
EMBED_FIELD_MUTE_COUNT = "寝落ちミュート回数"
...
EMBED_DESCRIPTION_UNMUTE_ON_CHANNEL_ACTIVE = " さんのいるチャンネルに他のメンバーが入室したため、サーバーミュートを解除しました。"
